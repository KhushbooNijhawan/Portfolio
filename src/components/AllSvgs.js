...
export const Linkedin = (props) => {
  return (
      <svg
        aria-hidden="true"
        data-prefix="linkedin-in"
        data-icon="linkedin"
        className="prefix__svg-inline--li prefix__li-linkedin prefix__fa-w-16"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
        {...props}
      >
...
export const Instagram = (props) => {
    return (
        <svg
          ...
          data-prefix="insta"
          data-icon="instagram"
          className="prefix__svg-inline--ig prefix__ig-instagram prefix__fa-w-18"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 30 30"
          {...props}
        >
